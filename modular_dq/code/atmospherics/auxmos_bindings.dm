...
/datum/gas_mixture/proc/adjust_multi(...)
	...
	return call_ext(VERDIGRIS, "byond:adjust_multi_hook_ffi")(arglist(args_copy))
...
/datum/gas_mixture/proc/adjust_heat(temp)
	return call_ext(VERDIGRIS, "byond:adjust_heat_hook_ffi")(src, temp)

/// Returns: the amount of gas mixtures that are attached to a byond gas mixture.
/datum/controller/subsystem/air/proc/get_amt_gas_mixes()
	return call_ext(VERDIGRIS, "byond:hook_amt_gas_mixes_ffi")()
...
/datum/gas_mixture/proc/get_by_flag(flag_val)
	return call_ext(VERDIGRIS, "byond:get_by_flag_hook_ffi")(src, flag_val)
...
/datum/gas_mixture/proc/transfer_to(other, moles)
	return call_ext(VERDIGRIS, "byond:transfer_hook_ffi")(src, other, moles)

/// Arg: (mixture). Makes src into a copy of the argument mixture.
/datum/gas_mixture/proc/copy_from(giver)
	return call_ext(VERDIGRIS, "byond:copy_from_hook_ffi")(src, giver)

/// Args: (coefficient). Multiplies all gases by this amount.
/datum/gas_mixture/proc/multiply(num_val)
	return call_ext(VERDIGRIS, "byond:multiply_hook_ffi")(src, num_val)
...
/datum/gas_mixture/proc/get_fuel_amount(temp)
	return call_ext(VERDIGRIS, "byond:fuel_amount_hook_ffi")(src, temp)

/// Returns: the total amount of gas mixtures in the arena, including "free" ones.
/datum/controller/subsystem/air/proc/get_max_gas_mixes()
	return call_ext(VERDIGRIS, "byond:hook_max_gas_mixes_ffi")()
...
/datum/gas_mixture/proc/__gasmixture_unregister()
	return call_ext(VERDIGRIS, "byond:unregister_gasmixture_hook_ffi")(src)

/// Returns: the mix's volume, in liters.
/datum/gas_mixture/proc/return_volume()
	return call_ext(VERDIGRIS, "byond:return_volume_hook_ffi")(src)
...
/datum/gas_mixture/proc/transfer_ratio_to(other, ratio)
	return call_ext(VERDIGRIS, "byond:transfer_ratio_hook_ffi")(src, other, ratio)
...
/datum/gas_mixture/proc/__gasmixture_register()
	return call_ext(VERDIGRIS, "byond:register_gasmixture_hook_ffi")(src)
...
/datum/gas_mixture/proc/get_oxidation_power(temp)
	return call_ext(VERDIGRIS, "byond:oxidation_power_hook_ffi")(src, temp)

/// Args: (coefficient). Divides all gases by this amount.
/datum/gas_mixture/proc/divide(num_val)
	return call_ext(VERDIGRIS, "byond:divide_hook_ffi")(src, num_val)
...
/datum/gas_mixture/proc/scrub_into(into, ratio_v, gas_list)
	return call_ext(VERDIGRIS, "byond:scrub_into_hook_ffi")(src, into, ratio_v, gas_list)
...
/datum/gas_mixture/proc/subtract(num_val)
	return call_ext(VERDIGRIS, "byond:subtract_hook_ffi")(src, num_val)
...
/datum/gas_mixture/proc/set_temperature(arg_temp)
	return call_ext(VERDIGRIS, "byond:set_temperature_hook_ffi")(src, arg_temp)

/// Args: (mixture). Merges the gas from the giver into src, without modifying the giver mix.
/datum/gas_mixture/proc/merge(giver)
	return call_ext(VERDIGRIS, "byond:merge_hook_ffi")(src, giver)
...
/datum/gas_mixture/proc/temperature_share(...)
	var/list/args_copy = args.Copy()
	args_copy.Insert(1, src)
	return call_ext(VERDIGRIS, "byond:temperature_share_hook_ffi")(arglist(args_copy))
...
/datum/gas_mixture/proc/set_min_heat_capacity(arg_min)
	return call_ext(VERDIGRIS, "byond:min_heat_cap_hook_ffi")(src, arg_min)
...
/datum/gas_mixture/proc/__remove(into, amount_arg)
	return call_ext(VERDIGRIS, "byond:remove_hook_ffi")(src, into, amount_arg)
...
/datum/gas_mixture/proc/__auxtools_parse_gas_string(string)
	return call_ext(VERDIGRIS, "byond:parse_gas_string_ffi")(src, string)

/// Args: (mixture). Makes `src` a copy of `mixture`, with volumes taken into account.
/datum/gas_mixture/proc/equalize_with(total)
	return call_ext(VERDIGRIS, "byond:equalize_with_hook_ffi")(src, total)
...
/datum/gas_mixture/proc/__remove_ratio(into, ratio_arg)
	return call_ext(VERDIGRIS, "byond:remove_ratio_hook_ffi")(src, into, ratio_arg)

/// Args: (amount). Adds the given amount to each gas.
/datum/gas_mixture/proc/add(num_val)
	return call_ext(VERDIGRIS, "byond:add_hook_ffi")(src, num_val)
...
/datum/gas_mixture/proc/__remove_by_flag(into, flag_val, amount_val)
	return call_ext(VERDIGRIS, "byond:remove_by_flag_hook_ffi")(src, into, flag_val, amount_val)
...
/proc/equalize_all_gases_in_list(gas_list)
	return call_ext(VERDIGRIS, "byond:equalize_all_hook_ffi")(gas_list)
...
/datum/gas_mixture/proc/compare(other)
	return call_ext(VERDIGRIS, "byond:compare_hook_ffi")(src, other)
