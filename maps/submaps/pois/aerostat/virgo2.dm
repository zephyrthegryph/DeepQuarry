...
/datum/map_template/virgo2/RareSample
	...
	mappath = "maps/submaps/pois/aerostat/RareSample.dmm"
	allow_duplicates = TRUE
	cost = 5
...
/datum/map_template/virgo2/SamplePocket
	...
	mappath = "maps/submaps/pois/aerostat/SamplePocket.dmm"
	allow_duplicates = TRUE
	cost = 5
...
/datum/map_template/virgo2/DJOutpost2
	...
	mappath = "maps/submaps/pois/aerostat/DJOutpost2.dmm"
	template_group = "Sif Free Radio"
	cost = 5
...
/datum/map_template/virgo2/Boombase
	...
	mappath = "maps/submaps/pois/aerostat/Boombase.dmm"
	cost = 5
...
/datum/map_template/virgo2/BSD
	...
	mappath = "maps/submaps/pois/aerostat/Blackshuttledown.dmm"
	cost = 30
*/
...
/datum/map_template/virgo2/Rockybase
	...
	mappath = "maps/submaps/pois/aerostat/Rockybase.dmm"
	cost = 35

/datum/map_template/virgo2/MHR
	name = "Manhack Rock"
	desc = "A rock filled with nasty Synthetics."
	mappath = "maps/submaps/pois/aerostat/MHR.dmm"
	cost = 15
...
/datum/map_template/virgo2/GovPatrol
	...
	mappath = "maps/submaps/pois/aerostat/GovPatrol.dmm"
	cost = 5
...
/datum/map_template/virgo2/DecoupledEngine
	...
	mappath = "maps/submaps/pois/aerostat/DecoupledEngine.dmm"
	cost = 15
...
/datum/map_template/virgo2/DoomP
	...
	mappath = "maps/submaps/pois/aerostat/DoomP.dmm"
	cost = 30
*/
