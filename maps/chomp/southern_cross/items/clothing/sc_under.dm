...
/obj/item/clothing/under/rank/pilot1
	...
	icon_state = "pilot1"
	worn_state = "pilot1"
	item_icons = list(slot_w_uniform_str = 'maps/chomp/southern_cross/icons/mob/sc_under.dmi')
	icon = 'maps/chomp/southern_cross/icons/obj/sc_uniforms.dmi'
	sprite_sheets = list(
		SPECIES_TESHARI = 'maps/chomp/southern_cross/icons/mob/species/teshari/sc_uniform.dmi'
	)
