...
/obj/structure/prop/desert_rock
	icon = 'icons/obj/desert_planet/desert_rocks.dmi'
...
/obj/structure/prop/desert_planet64x64
	name = "large rock"
	desc = "Sandy and smooth from erosion."
	icon = 'icons/obj/desert_planet/desert_props_64x64.dmi'
	density = TRUE
	anchored = TRUE
	can_buckle = FALSE
...
/obj/structure/prop/desert_planet160x160
	...
	desc = "Sandy and smooth from erosion."
	icon = 'icons/obj/desert_planet/desert_planet_160x160.dmi'
	density = TRUE
	anchored = TRUE
	can_buckle = FALSE
