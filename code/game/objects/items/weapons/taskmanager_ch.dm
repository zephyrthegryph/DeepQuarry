...
/obj/item/taskmanager
	...
	var/static/image/radial_image_bridge = image(icon = 'icons/chomp/mob/radial_ch.dmi', icon_state = "bridge")
	var/static/image/radial_image_engineering = image(icon= 'icons/chomp/mob/radial_ch.dmi', icon_state = "eng")
	var/static/image/radial_image_medical = image(icon = 'icons/chomp/mob/radial_ch.dmi', icon_state = "medbay")
	var/static/image/radial_image_science = image(icon = 'icons/chomp/mob/radial_ch.dmi', icon_state = "sci")
	var/static/image/radial_image_service = image(icon = 'icons/chomp/mob/radial_ch.dmi', icon_state = "bar")
	var/static/image/radial_image_security = image(icon = 'icons/chomp/mob/radial_ch.dmi', icon_state = "armory")
