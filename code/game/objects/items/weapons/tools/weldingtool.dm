...
/obj/item/weldingtool
	...
	DEFAULT_MATTER(list(MAT_STEEL = 70, MAT_GLASS = 30))
...
/obj/item/weldingtool/largetank
	...
	max_fuel = 40
	DEFAULT_MATTER(list(MAT_STEEL = 70, MAT_GLASS = 60))
...
/obj/item/weldingtool/hugetank
	...
	DEFAULT_MATTER(list(MAT_STEEL = 70, MAT_GLASS = 120))
...
/obj/item/weldingtool/mini
	...
	max_fuel = 10
	w_class = ITEMSIZE_SMALL
	DEFAULT_MATTER(list(MAT_METAL = 30, MAT_GLASS = 10))
	change_icons = 0
	toolspeed = 2
