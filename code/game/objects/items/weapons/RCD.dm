...
/obj/item/rcd
	...
	DEFAULT_MATTER(list(DEFAULT_WALL_MATERIAL = 50000))
...
/obj/item/rcd_ammo
	...
	DEFAULT_MATTER(list(DEFAULT_WALL_MATERIAL = 30000,MAT_GLASS = 15000))
	var/remaining = RCD_MAX_CAPACITY / 0.75

/obj/item/rcd_ammo/large
	name = "high-capacity matter cartridge"
	desc = "Do not ingest."
	DEFAULT_MATTER(list(DEFAULT_WALL_MATERIAL = 45000,MAT_GLASS = 22500))
