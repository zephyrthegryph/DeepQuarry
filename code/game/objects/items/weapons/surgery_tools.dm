...
/obj/item/surgical/retractor
	...
	DEFAULT_MATTER(list(MAT_STEEL = 10000, MAT_GLASS = 5000))
	drop_sound = 'sound/items/drop/scrap.ogg'
...
/obj/item/surgical/hemostat
	...
	icon_state = "hemostat"
	DEFAULT_MATTER(list(MAT_STEEL = 5000, MAT_GLASS = 2500))
...
/obj/item/surgical/surgicaldrill
	...
	DEFAULT_MATTER(list(MAT_STEEL = 15000, MAT_GLASS = 10000))
	force = 15.0
...
/obj/item/surgical/circular_saw
	...
	throw_speed = 3
	throw_range = 5
	DEFAULT_MATTER(list(MAT_STEEL = 20000,MAT_GLASS = 10000))
...
/obj/item/surgical/circular_saw/manager
	...
	w_class = ITEMSIZE_NORMAL
	DEFAULT_MATTER(list(MAT_STEEL = 25000,MAT_GLASS = 20000))
