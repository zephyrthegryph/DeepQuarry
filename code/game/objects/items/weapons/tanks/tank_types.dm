...
/obj/item/tank/oxygen/examine(mob/user)
	. = ..()
	if(loc == user && (air_contents.get_moles(GAS_O2) < 10))
...
/obj/item/tank/anesthetic/Initialize(mapload)
	...
	air_contents.adjust_gas(GAS_O2, ((3*ONE_ATMOSPHERE)*70/(R_IDEAL_GAS_EQUATION*T20C) * O2STANDARD) - air_contents.get_moles(GAS_O2))
	air_contents.adjust_gas(GAS_N2O, ((3*ONE_ATMOSPHERE)*70/(R_IDEAL_GAS_EQUATION*T20C) * N2STANDARD) - air_contents.get_moles(GAS_N2O))
...
/obj/item/tank/air/examine(mob/user)
	. = ..()
	if(loc == user && (air_contents.get_moles(GAS_O2) < 1))
...
/obj/item/tank/emergency/oxygen/examine(mob/user)
	. = ..()
	if(loc == user && (air_contents.get_moles(GAS_O2) < 0.2))
...
/obj/item/tank/nitrogen/examine(mob/user)
	. = ..()
	if(loc == user && (air_contents.get_moles(GAS_N2) < 10))
...
/obj/item/tank/methane/examine(mob/user)
	. = ..()
	if(loc == user && (air_contents.get_moles(GAS_CH4) < 10))
