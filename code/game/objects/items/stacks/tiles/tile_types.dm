...
/obj/item/stack/tile/floor
	...
	icon_state = "tile"
	force = 6.0
	DEFAULT_MATTER(list(DEFAULT_WALL_MATERIAL = SHEET_MATERIAL_AMOUNT / 4))
	throwforce = 15.0
	throw_speed = 5
	throw_range = 20
	no_variants = FALSE
...
/obj/item/stack/tile/floor/steel_dirty
	...
	DEFAULT_MATTER(list(MAT_PLASTEEL = SHEET_MATERIAL_AMOUNT / 4))
...
/obj/item/stack/tile/floor/white
	...
	icon_state = "tile_white"
	DEFAULT_MATTER(list(MAT_PLASTIC = SHEET_MATERIAL_AMOUNT / 4))
...
/obj/item/stack/tile/floor/gold
	...
	DEFAULT_MATTER(list(MAT_GOLD = SHEET_MATERIAL_AMOUNT / 4))
...
/obj/item/stack/tile/floor/silver
	...
	DEFAULT_MATTER(list(MAT_SILVER = SHEET_MATERIAL_AMOUNT / 4))
...
/obj/item/stack/tile/floor/phoron
	...
	DEFAULT_MATTER(list(MAT_PHORON = SHEET_MATERIAL_AMOUNT / 4))
...
/obj/item/stack/tile/floor/diamond
	...
	DEFAULT_MATTER(list(MAT_DIAMOND = SHEET_MATERIAL_AMOUNT / 4))
...
/obj/item/stack/tile/floor/uranium
	...
	DEFAULT_MATTER(list(MAT_URANIUM = SHEET_MATERIAL_AMOUNT / 4))
