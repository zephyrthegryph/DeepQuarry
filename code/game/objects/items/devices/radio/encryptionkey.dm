...
/obj/item/encryptionkey/heads/rd
	name = "research director's encryption key"
	icon_state = "rd_cypherkey"
	channels = list(CHANNEL_COMMAND = 1, CHANNEL_SCIENCE = 1, CHANNEL_EXPLORATION = 1) // , adds Exploration
...
/obj/item/encryptionkey/pathfinder
	...
	icon_state = "com_cypherkey"
	channels = list(/*CHANNEL_COMMAND = 1,*/ CHANNEL_EXPLORATION = 1) // Remove Command

/obj/item/encryptionkey/qm
	name = "quartermaster's encryption key"
	icon_state = "qm_cypherkey"
	channels = list(/*CHANNEL_COMMAND = 1,*/ CHANNEL_SUPPLY = 1) // Remove Command
...
/obj/item/encryptionkey/explorer
	name = "explorer's encryption key" // explo keep
	icon_state = "rob_cypherkey"
	channels = list(CHANNEL_EXPLORATION = 1)
