/obj/structure
	...
	var/list/blend_objects = null // Objects which to blend with
	var/list/noblend_objects = null //Objects to avoid blending with (such as children of listed blend objects.
