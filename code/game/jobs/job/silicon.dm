...
/datum/job/cyborg
	...
	total_positions = 8 // Along with one able to spawn later in the round. // Doubles total spawn positions for cyborgs.
	spawn_positions = 6 // Let's have 3 able to spawn in roundstart // Doubles total spawn positions for cyborgs.
