...
/datum/job/hos
	...
	access = list(ACCESS_SECURITY, ACCESS_EVA, ACCESS_SEC_DOORS, ACCESS_BRIG, ACCESS_ARMORY,
							...
							ACCESS_HEADS, ACCESS_HOS, ACCESS_RC_ANNOUNCE, ACCESS_KEYCARD_AUTH, ACCESS_GATEWAY, ACCESS_EXTERNAL_AIRLOCKS, ACCESS_TELEPORTER) // Restores what access is given in security.dm.
...
/datum/job/detective
	...
	supervisors = "the " + JOB_HEAD_OF_SECURITY
	selection_color = "#601C1C"
	access = list(ACCESS_SECURITY, ACCESS_SEC_DOORS, ACCESS_FORENSICS_LOCKERS, ACCESS_MORGUE, ACCESS_MAINT_TUNNELS, ACCESS_EVA, ACCESS_EXTERNAL_AIRLOCKS, ACCESS_BRIG) // ACCESS_BRIG
...
/datum/job/officer
	...
	supervisors = "the " + JOB_HEAD_OF_SECURITY
	selection_color = "#601C1C"
	economic_modifier = 5 // "Offduty officers make more than working, and this brings it in line with the rest of the jobs in sec barring HOS"
