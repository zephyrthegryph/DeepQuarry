...
/datum/job/pilot
	title = "Pilot"
	flag = PILOT
	departments = list(DEPARTMENT_PLANET) // keep them part of exploration
	department_flag = MEDSCI
	faction = "Station"
	total_positions = 5
	spawn_positions = 5
	...
	pto_type = PTO_EXPLORATION
	access = list(ACCESS_PILOT, ACCESS_EXTERNAL_AIRLOCKS, ACCESS_EVA, ACCESS_EXPLORER) // gave pilot a little more access
	minimal_access = list(ACCESS_PILOT, ACCESS_EXTERNAL_AIRLOCKS, ACCESS_EVA, ACCESS_EXPLORER) // gave pilot a little more access
	outfit_type = /datum/decl/hierarchy/outfit/job/pilot
	job_description = "A Pilot flies the various shuttles in the Vir System." // Replaces Virgo reference with Vir.
...
/datum/job/sar
	...
	minimal_player_age = 3
	pto_type = PTO_EXPLORATION
	access = list(ACCESS_MEDICAL, ACCESS_MEDICAL_EQUIP, ACCESS_MORGUE, ACCESS_EVA, ACCESS_MAINT_TUNNELS, ACCESS_EXTERNAL_AIRLOCKS,ACCESS_EXPLORER) // No more pilot, surgery or chemistry access.
	minimal_access = list(ACCESS_MEDICAL, ACCESS_MEDICAL_EQUIP, ACCESS_MORGUE,ACCESS_EXPLORER) // No more pilot access.
