...
/datum/job/rd
	...
	access = list(ACCESS_RD, ACCESS_HEADS, ACCESS_TOX, ACCESS_GENETICS, ACCESS_MORGUE,
						...
						ACCESS_EXPLORER, ACCESS_PATHFINDER, ACCESS_XENOBOTANY) // access_gateway, _explorer, _pathfinder, and _xenobotany
...
/datum/job/xenobotanist
	...
	selection_color = "#633D63"
	economic_modifier = 7
	access = list(ACCESS_ROBOTICS, ACCESS_TOX, ACCESS_TOX_STORAGE, ACCESS_RESEARCH, ACCESS_XENOBOTANY, ACCESS_HYDROPONICS, ACCESS_XENOBIOLOGY)
