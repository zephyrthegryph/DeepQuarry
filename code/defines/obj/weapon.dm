...
/obj/item/SWF_uplink
	...
	throw_speed = 4
	throw_range = 20
	DEFAULT_MATTER(list(MAT_STEEL = 100))
	drop_sound = 'sound/items/drop/device.ogg'
	pickup_sound = 'sound/items/pickup/device.ogg'
...
/obj/item/stock_parts/console_screen
	...
	icon_state = "screen"
	DEFAULT_MATTER(list(MAT_GLASS = 200))

/obj/item/stock_parts/capacitor
	name = "capacitor"
	desc = "A basic capacitor used in the construction of a variety of devices."
	icon_state = "capacitor"
	DEFAULT_MATTER(list(MAT_STEEL = 50,MAT_GLASS = 50))
...
/obj/item/stock_parts/manipulator
	...
	DEFAULT_MATTER(list(MAT_STEEL = 30))

/obj/item/stock_parts/micro_laser
	name = "micro-laser"
	desc = "A tiny laser used in certain devices."
	icon_state = "micro_laser"
	DEFAULT_MATTER(list(MAT_STEEL = 10,MAT_GLASS = 20))
...
/obj/item/stock_parts/subspace/ansible
	...
	DEFAULT_MATTER(list(MAT_STEEL = 30,MAT_GLASS = 10))
...
/obj/item/stock_parts/motor
	...
	icon = 'icons/obj/stock_parts.dmi'
	icon_state = "motor"
	DEFAULT_MATTER(list(MAT_STEEL = 60, MAT_GLASS = 10))
...
/obj/item/stock_parts/spring
	...
	icon = 'icons/obj/stock_parts.dmi'
	icon_state = "spring"
	DEFAULT_MATTER(list(MAT_STEEL = 40))
