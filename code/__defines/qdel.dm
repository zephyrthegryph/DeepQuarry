...
*/
// Intentionally enabled in this fork: hard-delete reference reports are part of
// the GC regression suite and live diagnostics, not an accidental debug build.
