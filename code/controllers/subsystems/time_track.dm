...
/datum/controller/subsystem/time_track/Initialize()
	...
	log_perf(
		list(
			...
			"air_pipenets_cost",
			"air_rebuilds_cost",
			"air_active_turf_count",
			"air_seed_turf_count",
			"air_retained_turf_count",
			"air_pending_turf_count",
			"air_snapshot_mixture_count",
			"air_published_mixture_count",
			"air_closed_component_count",
			"air_rejected_generation_count",
			"air_conservation_rejection_count",
			"air_group_turf_count",
			"air_equalize_turf_count",
			"air_hotspot_count",
			"air_network_count",
			"air_delta_count",
			"air_subsystem_cost",
			...
			"machines_gas_wakes",
			"reactor_subsystem_cost",
			"reactor_subsystem_ticks",
			"reactor_subsystem_overrun",
			"reactor_continuous_count",
			"mobs_subsystem_cost",
			"mobs_subsystem_ticks",
			"mobs_subsystem_overrun",
			"mob_count",
			"ai_subsystem_cost",
...
/datum/controller/subsystem/time_track/fire()
	...
	log_perf(
		list(
			...
			SSair.cost_pipenets,
			SSair.cost_rebuilds,
			SSair.async_active_turfs,
			SSair.async_seed_turfs,
			SSair.async_retained_turfs,
			SSair.async_pending_turfs,
			SSair.async_snapshot_mixtures,
			SSair.async_published_mixtures,
			SSair.async_closed_components,
			SSair.async_rejected_generations,
			SSair.async_conservation_rejections,
			...
			SSreactor.cost,
			SSreactor.ticks,
			SSreactor.tick_overrun,
			length(SSreactor.continuous),
			SSmobs.cost,
			SSmobs.ticks,
			SSmobs.tick_overrun,
