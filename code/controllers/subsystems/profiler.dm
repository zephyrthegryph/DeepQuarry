...
/datum/controller/subsystem/profiler/fire()
	...
	subsystems["mobs"] += list("counts" = list("world" = length(GLOB.mob_list), "parked" = om_pipeline_parked_count(/datum/om/pipeline/life), "frames" = om_pipeline_frames(/datum/om/pipeline/life), "deaths_pending" = length(SSmobs.death_list)))
