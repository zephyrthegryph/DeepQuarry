...
/datum/controller/subsystem/profiler/fire()
	...
	subsystems["machines"] += list(
		...
		"counts" = list("processing" = length(SSmachines.processing_machines), "all" = length(SSmachines.all_machines), "powernets" = length(SSmachines.powernets), "active_powernets" = length(SSmachines.active_powernets), "power_objects" = length(SSmachines.powerobjs), "hibernating_vents" = length(SSmachines.hibernating_vents)),
