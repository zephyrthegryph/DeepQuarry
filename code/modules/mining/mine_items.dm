...
/obj/item/pickaxe/advdrill
	...
	digspeed = 27
	sand_dig = TRUE
	DEFAULT_MATTER(list(MAT_STEEL = 4000, MAT_PLASTEEL = 2500))
...
/obj/item/pickaxe/diamonddrill //When people ask about the badass leader of the mining tools, they are talking about ME!
	...
	sand_dig = TRUE
	DEFAULT_MATTER(list(MAT_STEEL = 4500, MAT_PLASTEEL = 3000, MAT_DIAMONDS = 1000))
...
/obj/item/pickaxe/plasmacutter
	...
	DEFAULT_MATTER(list(MAT_STEEL = 3000, MAT_PLASTEEL = 1500, MAT_DIAMONDS = 500, MAT_PHORON = 500))
	drill_verb = "cutting"
...
/obj/item/shovel
	...
	DEFAULT_MATTER(list(MAT_STEEL = 50))
...
/obj/item/shovel/wood/Initialize(mapload, _mat)
	...
	if(!istype(material))
		...
		set_matter(list("[material.name]" = 50))
		update_icon()
...
/obj/item/shovel/wood
	...
	w_class = ITEMSIZE_NORMAL
	DEFAULT_MATTER(list(MAT_WOOD = 50))
	sharp = 0
	edge = 1
...
/obj/item/ice_pick
	...
	icon_state = "icepick"
	item_state = "icepick"
	DEFAULT_MATTER(list(MAT_STEEL = 12000)) //Same as a knife
