...
/datum/contract/faction_agent/proc/configure_red_operation(profile_id)
	...
	switch(agent_faction)
		...
		if(REPUTATION_FACTION_TALON)
			add_agent_count(CONTRACT_EVENT_INFRASTRUCTURE_REPAIRED, 350, "Contested field work", "Complete 350 points of unauthorized industrial restoration.", "repair_amount")
