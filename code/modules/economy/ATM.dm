...
/obj/machinery/atm/proc/scan_user(mob/living/carbon/human/human_user as mob)
	if(!authenticated_account)
		if(human_user.get_equipped_item(SLOT_ID_WEAR_ID))
			var/obj/item/card/id/I
			if(istype(human_user.get_equipped_item(SLOT_ID_WEAR_ID), /obj/item/card/id) )
				I = human_user.get_equipped_item(SLOT_ID_WEAR_ID)
			else if(istype(human_user.get_equipped_item(SLOT_ID_WEAR_ID), /obj/item/pda) )
				var/obj/item/pda/P = human_user.get_equipped_item(SLOT_ID_WEAR_ID)
				I = P.id
			if(I)
