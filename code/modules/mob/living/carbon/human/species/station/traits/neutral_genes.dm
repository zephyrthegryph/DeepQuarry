// Note: TRAITGENETICS - Originally, these were in negative_genes.dm
...
/datum/trait/negative/disability_censored // neutral -> negative
	name = "Censored"
	desc = "You are unable to speak profanity. To an excessive degree..."
	cost = -1 // TRAITGENETICS - Originally was -1 // 0 -> -1
	custom_only = FALSE
...
/datum/trait/negative/disability_nervousness // neutral -> negative
	name = "Nervousness"
...
/datum/trait/neutral/disability_tourettes
	...
	is_genetrait = TRUE // Enable tourettes
	hidden = FALSE // Enable tourettes
