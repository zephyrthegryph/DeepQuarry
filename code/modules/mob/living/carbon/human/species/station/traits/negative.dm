...
/datum/trait/negative/endurance_low
	name = "Low Endurance"
	desc = "Reduces your maximum total hitpoints to 75.  You require only 150 damage in total to die, compared to 200 normally. You will go into crit after losing 75 HP, compared to crit at 100 HP." // Clarity for players' sake.
	cost = -4 // makes you a lot squishier, should not be only 2 points. (based on the brute and burn vulnerability costs)
...
/datum/trait/negative/endurance_very_low
	...
	desc = "Reduces your maximum total hitpoints to 50.  You require only 100 damage in total to die, compared to 200 normally. You will go into crit after losing 50 HP, compared to crit at 100 HP." // Clarity for players' sake.
	cost = -8 // Teshari HP. This makes the person a lot more suseptable to getting stunned, killed, etc. // Has no business being only 3 points, while others that function similarly but are nowhere near as crippling are 3 as well.
...
/datum/trait/negative/haemophilia
	name = "Haemophilia" // Trait List Organization
	desc = "When you bleed, you bleed a LOT. Double the bloodloss rate." // More Trait Feedback for players.
	cost = -2
...
/datum/trait/negative/lightweight
	name = "Lightweight"
	desc = "Your light weight and poor balance make you very susceptible to unhelpful bumping. Think of it like a bowling ball versus a pin. (STOP TAKING THIS AS SECURITY! We're MRP, so expect to lose your junk immediately, especially in events. - Love, Admins)" //btw
	cost = -2
	var_changes = list("lightweight" = 1)
	excludes = list(/datum/trait/negative/lightweight_light) // Added a lesser version of this trait
	custom_only = FALSE
