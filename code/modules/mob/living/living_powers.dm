...
/mob/living/proc/hide()
	...
	if(stat == DEAD || get_paralysis() || get_weakened() || get_stunned() || restrained() || buckled || LAZYLEN(grabbed_by) || has_buckled_mobs()) //VORE EDIT: Check for has_buckled_mobs() (taur riding)
		return
