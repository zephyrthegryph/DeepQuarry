 ...
 */
/obj/item/clothing/head/soft/solgov
	name = "\improper SolGov cap" // SolGov
	desc = "It's a blue ballcap in Solar Central Government colors." // SolGov
...
/obj/item/clothing/head/soft/solgov/fleet
	name = "fleet cap"
	desc = "It's a navy blue ballcap with a USDF Fleet crest." // TCG to USDF

/obj/item/clothing/head/utility/fleet
	name = "fleet utility cover"
	desc = "A navy blue utility cover bearing the crest of a USDF Fleet." // TCG to USDF

/obj/item/clothing/head/utility/army
	name = "marine utility cover"
	desc = "A green utility cover bearing the crest of the USDF Marines." // TCG to USDF

/obj/item/clothing/head/utility/army/tan
	name = "tan utility cover"
	desc = "A tan utility cover bearing the crest of the USDF Marines." // TCG to USDF

/obj/item/clothing/head/utility/army/urban
	name = "urban utility cover"
	desc = "A grey utility cover bearing the crest of the USDF Marines." // TCG to USDF
...
/obj/item/clothing/head/service/army
	name = "marine wheel cover"
	desc = "A green service uniform cover with an USDF Marine crest." // TCG to USDF

/obj/item/clothing/head/service/army/command
	name = "marine officer's wheel cover"
	desc = "A green service uniform cover with an USDF Marine crest and gold stripe." // TCG to USDF

/obj/item/clothing/head/service/army/garrison
	name = "marine garrison cap"
	desc = "A green garrison cap belonging to the USDF Marine." // TCG to USDF

/obj/item/clothing/head/service/army/garrison/command
	name = "marine officer's garrison cap"
	desc = "A green garrison cap belonging to the USDF Marine. This one has a gold pin." // TCG to USDF

/obj/item/clothing/head/service/army/campaign
	name = "campaign cover"
	desc = "A green campaign cover with an USDF Marine crest. Only found on the heads of Drill Sergeants." // TCG to USDF
...
/obj/item/clothing/head/dress/fleet
	name = "fleet dress wheel cover"
	desc = "A white dress uniform cover. This one has an USDF Fleet crest." // TCG to USDF

/obj/item/clothing/head/dress/fleet/command
	name = "fleet officer's dress wheel cover"
	desc = "A white dress uniform cover. This one has a gold stripe and an USDF Fleet crest." // TCG to USDF

/obj/item/clothing/head/dress/army
	name = "marine dress wheel cover"
	desc = "A white dress uniform cover with an USDF Marine crest." // TCG to USDF

/obj/item/clothing/head/dress/army/command
	name = "marine officer's dress wheel cover"
	desc = "A white dress uniform cover with an USDF Marine crest and gold stripe." // TCG to USDF
...
/obj/item/clothing/head/beret/solgov
	...
	desc = "A beret in Solar Central Government colors. For peacekeepers that are more inclined towards style than safety." // Terran Commonwealth to Solar Central Government
...
/obj/item/clothing/head/beret/solgov/fleet
	name = "fleet beret"
	desc = "A navy blue beret belonging to the USDF Fleet. For personnel that are more inclined towards style than safety." // TCG to USDF

/obj/item/clothing/head/beret/solgov/fleet/security
	name = "fleet security beret"
	desc = "An USDF Fleet beret with a security crest. For personnel that are more inclined towards style than safety." // TCG to USDF

/obj/item/clothing/head/beret/solgov/fleet/medical
	name = "fleet medical beret"
	desc = "An USDF Fleet beret with a medical crest. For personnel that are more inclined towards style than safety." // TCG to USDF

/obj/item/clothing/head/beret/solgov/fleet/engineering
	name = "fleet engineering beret"
	desc = "An USDF Fleet with an engineering crest. For personnel that are more inclined towards style than safety." // TCG to USDF

/obj/item/clothing/head/beret/solgov/fleet/supply
	name = "fleet supply beret"
	desc = "An USDF Fleet beret with a supply crest. For personnel that are more inclined towards style than safety." // TCG to USDF

/obj/item/clothing/head/beret/solgov/fleet/service
	name = "fleet service beret"
	desc = "An USDF Fleet beret with a service crest. For personnel that are more inclined towards style than safety." // TCG to USDF

/obj/item/clothing/head/beret/solgov/fleet/exploration
	name = "fleet exploration beret"
	desc = "An USDF Fleet beret with an exploration crest. For personnel that are more inclined towards style than safety." // TCG to USDF

/obj/item/clothing/head/beret/solgov/fleet/command
	name = "fleet command beret"
	desc = "An USDF Fleet beret with a command crest. For personnel that are more inclined towards style than safety." // TCG to USDF

/obj/item/clothing/head/beret/solgov/fleet/dress
	name = "fleet dress beret"
	desc = "A white USDF Fleet beret. For personnel that are more inclined towards style than safety." // TCG to USDF

/obj/item/clothing/head/beret/solgov/fleet/dress/command
	name = "fleet officer's dress beret"
	desc = "A white USDF Fleet beret with a golden crest. For personnel that are more inclined towards style than safety." // TCG to USDF

/obj/item/clothing/head/beret/solgov/fleet/branch
	name = "first fleet beret"
	desc = "An USDF Fleet beret carrying insignia of First Fleet, the Sol Guard, stationed in Sol. For personnel that are more inclined towards style than safety." // TCG to USDF
	icon_state = "beret_navy_first"

/obj/item/clothing/head/beret/solgov/fleet/branch/second
	name = "second fleet beret"
	desc = "An USDF Fleet beret carrying insignia of Second Fleet, the Home Guard, tasked with defense of Sol territories. For personnel that are more inclined towards style than safety." // TCG to USDF

/obj/item/clothing/head/beret/solgov/fleet/branch/third
	name = "third fleet beret"
	desc = "An USDF Fleet beret carrying insignia of Third Fleet, the Border Guard, guarding borders of Sol territory against Vox and pirates. For personnel that are more inclined towards style than safety." // TCG to USDF

/obj/item/clothing/head/beret/solgov/fleet/branch/fourth
	name = "fourth fleet beret"
	desc = "An USDF Fleet beret carrying insignia of Fourth Fleet, stationed on Skrell border. For personnel that are more inclined towards style than safety." // TCG to USDF

/obj/item/clothing/head/beret/solgov/fleet/branch/fifth
	name = "fifth fleet beret"
	desc = "An USDF Fleet beret carrying insignia of Fifth Fleet, the Quick Reaction Force, recently formed and outfited with last tech. For personnel that are more inclined towards style than safety." // TCG to USDF
...
/obj/item/clothing/head/ushanka/solgov/fleet
	name = "fleet fur hat"
	desc = "An USDF Fleet synthfur-lined hat for operating in cold environments." // TCG to USDF

/obj/item/clothing/head/ushanka/solgov/marine
	name = "marine fur hat"
	desc = "An USDF Marine synthfur-lined hat for operating in cold environments." // TCG to USDF
