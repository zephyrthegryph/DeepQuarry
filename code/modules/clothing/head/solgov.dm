...
/obj/item/clothing/head/utility/army/tan
	...
	desc = "A tan utility cover bearing the crest of the USDF Marines."
	icon_state = "tanutility"

/obj/item/clothing/head/utility/army/urban
	name = "urban utility cover"
	desc = "A grey utility cover bearing the crest of the USDF Marines."
	icon_state = "greyutility"
...
/obj/item/clothing/head/service/army
	...
	desc = "A green service uniform cover with an USDF Marine crest."
	icon_state = "greenwheelcap"

/obj/item/clothing/head/service/army/command
	name = "marine officer's wheel cover"
	desc = "A green service uniform cover with an USDF Marine crest and gold stripe."
	icon_state = "greenwheelcap_com"

/obj/item/clothing/head/service/army/garrison
	name = "marine garrison cap"
	desc = "A green garrison cap belonging to the USDF Marine."
	icon_state = "greengarrisoncap"

/obj/item/clothing/head/service/army/garrison/command
	name = "marine officer's garrison cap"
	desc = "A green garrison cap belonging to the USDF Marine. This one has a gold pin."
	icon_state = "greengarrisoncap_com"

/obj/item/clothing/head/service/army/campaign
	name = "campaign cover"
	desc = "A green campaign cover with an USDF Marine crest. Only found on the heads of Drill Sergeants."
...
/obj/item/clothing/head/dress/army
	...
	desc = "A white dress uniform cover with an USDF Marine crest."
	icon_state = "whitewheelcap"

/obj/item/clothing/head/dress/army/command
	name = "marine officer's dress wheel cover"
	desc = "A white dress uniform cover with an USDF Marine crest and gold stripe."
...
/obj/item/clothing/head/beret/solgov/fleet/service
	...
	desc = "An USDF Fleet beret with a service crest. For personnel that are more inclined towards style than safety."
	icon_state = "beret_navy_service"

/obj/item/clothing/head/beret/solgov/fleet/exploration
	name = "fleet exploration beret"
	desc = "An USDF Fleet beret with an exploration crest. For personnel that are more inclined towards style than safety."
...
/obj/item/clothing/head/beret/solgov/fleet/dress
	...
	desc = "A white USDF Fleet beret. For personnel that are more inclined towards style than safety."
	icon_state = "beret_whiterim"

/obj/item/clothing/head/beret/solgov/fleet/dress/command
	name = "fleet officer's dress beret"
	desc = "A white USDF Fleet beret with a golden crest. For personnel that are more inclined towards style than safety."
	icon_state = "beret_whiterim_com"

/obj/item/clothing/head/beret/solgov/fleet/branch
	name = "first fleet beret"
	desc = "An USDF Fleet beret carrying insignia of First Fleet, the Sol Guard, stationed in Sol. For personnel that are more inclined towards style than safety."
	icon_state = "beret_navy_first"

/obj/item/clothing/head/beret/solgov/fleet/branch/second
	name = "second fleet beret"
	desc = "An USDF Fleet beret carrying insignia of Second Fleet, the Home Guard, tasked with defense of Sol territories. For personnel that are more inclined towards style than safety."

/obj/item/clothing/head/beret/solgov/fleet/branch/third
	name = "third fleet beret"
	desc = "An USDF Fleet beret carrying insignia of Third Fleet, the Border Guard, guarding borders of Sol territory against Vox and pirates. For personnel that are more inclined towards style than safety."

/obj/item/clothing/head/beret/solgov/fleet/branch/fourth
	name = "fourth fleet beret"
	desc = "An USDF Fleet beret carrying insignia of Fourth Fleet, stationed on Skrell border. For personnel that are more inclined towards style than safety."

/obj/item/clothing/head/beret/solgov/fleet/branch/fifth
	name = "fifth fleet beret"
	desc = "An USDF Fleet beret carrying insignia of Fifth Fleet, the Quick Reaction Force, recently formed and outfited with last tech. For personnel that are more inclined towards style than safety."
...
/obj/item/clothing/head/ushanka/solgov/fleet
	name = "fleet fur hat"
	desc = "An USDF Fleet synthfur-lined hat for operating in cold environments."
	icon_state = "flushankadown"

/obj/item/clothing/head/ushanka/solgov/marine
	name = "marine fur hat"
	desc = "An USDF Marine synthfur-lined hat for operating in cold environments."
