...
// === merged from hooded_ch.dm during hard-fork de-suffix (verified no override-order change) ===
...
// === merged from hooded_vr.dm during hard-fork de-suffix (verified no override-order change) ===
