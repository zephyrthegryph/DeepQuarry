...
/obj/item/rig/ch/aegis/bullet_act(obj/item/projectile/P)
...
/obj/item/clothing/suit/space/rig/ch/aegis/bullet_act(obj/item/projectile/P)
	var/reflectchance = 70 - round(P.damage)
	if(prob(reflectchance))
		visible_message(span_danger("The [P.name] gets reflected by [src]'s shell!"), \
						span_userdanger("The [P.name] gets reflected by [src]'s shell!"))
...
/obj/item/clothing/head/helmet/space/rig/ch/aegis/bullet_act(obj/item/projectile/P)
	var/reflectchance = 70 - round(P.damage)
	if(prob(reflectchance))
		visible_message(span_danger("The [P.name] gets reflected by [src]'s shell!"), \
						span_userdanger("The [P.name] gets reflected by [src]'s shell!"))
...
/obj/item/clothing/gloves/gauntlets/rig/ch/aegis/bullet_act(obj/item/projectile/P)
	var/reflectchance = 70 - round(P.damage)
	if(prob(reflectchance))
		visible_message(span_danger("The [P.name] gets reflected by [src]'s shell!"), \
						span_userdanger("The [P.name] gets reflected by [src]'s shell!"))
...
/obj/item/clothing/shoes/magboots/rig/ch/aegis/bullet_act(obj/item/projectile/P)
	var/reflectchance = 70 - round(P.damage)
	if(prob(reflectchance))
		visible_message(span_danger("The [P.name] gets reflected by [src]'s shell!"), \
						span_userdanger("The [P.name] gets reflected by [src]'s shell!"))
