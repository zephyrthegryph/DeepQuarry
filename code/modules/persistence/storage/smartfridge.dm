...
/datum/persistent/storage/smartfridge/sheet_storage/lossy
	...
	min_retained = 50 // Altering how many items can be held between rounds.
	max_retained = 50 // Altering how many items can be held between rounds.
	min_storage = 1 // if the amount is at or below this, don't cull // Altering how many items can be held between rounds.
	max_storage = 2500 // if the amount is above this, cull it to this amount THEN do math // Altering how many items can be held between rounds.
