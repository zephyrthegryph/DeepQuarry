...
/datum/unit_test/dq_interaction_snapshots
	...
	var/static/list/expected = list(
		...
		"/obj/machinery/pipelayer|human|screwdriver => machine_panel,pipelayer_toggle|machine_part_replacement:needs a rapid part exchange device,pipelayer_recycle_pipe:needs a pipe,pipelayer_load_metal:needs an item",
		...
		"/obj/machinery/vending|human|screwdriver => vending_stock,vending_use,vending_check_logs|machine_anchor:needs a wrench,vending_id_dispatch:not possible right now,vending_refill:needs a vending refill cartridge,vending_fake_coin:needs a Coin,vending_coin:needs a Coin",
