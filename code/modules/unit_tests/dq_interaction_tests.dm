...
/datum/unit_test/dq_interaction_snapshots
	...
	var/static/list/expected = list(
		...
		"/obj/machinery/smartfridge|human|none => |machine_deconstruct:needs a crowbar,machine_anchor:needs a wrench",
		"/obj/machinery/smartfridge|human|screwdriver => |machine_deconstruct:needs a crowbar,machine_anchor:needs a wrench",
		"/obj/machinery/smartfridge|human|crowbar => |machine_deconstruct:the maintenance panel is closed,machine_anchor:needs a wrench",
		"/obj/machinery/smartfridge|human|wrench => machine_anchor|machine_deconstruct:needs a crowbar",
		"/obj/machinery/smartfridge|human|welder => |machine_deconstruct:needs a crowbar,machine_anchor:needs a wrench",
		"/obj/machinery/smartfridge|robot|screwdriver => |machine_deconstruct:needs a crowbar,machine_anchor:needs a wrench",
		"/obj/machinery/smartfridge|ghost|screwdriver => |",
		"/obj/machinery/smartfridge|ai|none => |",
		...
		"/obj/machinery/dq_maint_probe|human|none => |machine_panel:needs a screwdriver,machine_deconstruct:needs a crowbar,machine_anchor:needs a wrench,machine_repair:needs a welding tool",
		"/obj/machinery/dq_maint_probe|human|screwdriver => machine_panel|machine_deconstruct:needs a crowbar,machine_anchor:needs a wrench,machine_repair:needs a welding tool",
		"/obj/machinery/dq_maint_probe|human|crowbar => |machine_panel:needs a screwdriver,machine_deconstruct:the maintenance panel is closed,machine_anchor:needs a wrench,machine_repair:needs a welding tool",
		"/obj/machinery/dq_maint_probe|human|wrench => machine_anchor|machine_panel:needs a screwdriver,machine_deconstruct:needs a crowbar,machine_repair:needs a welding tool",
		...
		"/obj/machinery/dq_maint_probe|robot|screwdriver => machine_panel|machine_deconstruct:needs a crowbar,machine_anchor:needs a wrench,machine_repair:needs a welding tool",
