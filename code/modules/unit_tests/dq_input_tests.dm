...
/datum/unit_test/dq_keybinding_defaults_match_old_skin
	var/static/list/old_skin_macros = list(
		...
		"[KEYBIND_PROFILE_ROBOT]|INSERT|a-intent right",
		...
		"[KEYBIND_PROFILE_ROBOT]|4|a-intent left",
		"[KEYBIND_PROFILE_ROBOT]|CTRL+4|a-intent left",
		...
		"[KEYBIND_PROFILE_ROBOT]|F|a-intent left",
		"[KEYBIND_PROFILE_ROBOT]|CTRL+F|a-intent left",
		"[KEYBIND_PROFILE_ROBOT]|G|a-intent right",
		"[KEYBIND_PROFILE_ROBOT]|CTRL+G|a-intent right",
		...
		"[KEYBIND_PROFILE_DEFAULT]|INSERT|a-intent right",
		"[KEYBIND_PROFILE_DEFAULT]|DELETE|delete-key-pressed",
		"[KEYBIND_PROFILE_DEFAULT]|1|a-intent help",
		"[KEYBIND_PROFILE_DEFAULT]|CTRL+1|a-intent help",
		"[KEYBIND_PROFILE_DEFAULT]|2|a-intent disarm",
		"[KEYBIND_PROFILE_DEFAULT]|CTRL+2|a-intent disarm",
		"[KEYBIND_PROFILE_DEFAULT]|3|a-intent grab",
		"[KEYBIND_PROFILE_DEFAULT]|CTRL+3|a-intent grab",
		"[KEYBIND_PROFILE_DEFAULT]|4|a-intent harm",
		"[KEYBIND_PROFILE_DEFAULT]|CTRL+4|a-intent harm",
		...
		"[KEYBIND_PROFILE_DEFAULT]|F|a-intent left",
		"[KEYBIND_PROFILE_DEFAULT]|CTRL+F|a-intent left",
		"[KEYBIND_PROFILE_DEFAULT]|G|a-intent right",
		"[KEYBIND_PROFILE_DEFAULT]|CTRL+G|a-intent right",
