...
/datum/event/horde_infestation/setup()
	...
	for(var/obj/machinery/atmospherics/unary/vent_pump/temp_vent in REGISTRY_MEMBERS(REGISTRY_MACHINES)) //Gathering together all possible areas to spawn mobs.
