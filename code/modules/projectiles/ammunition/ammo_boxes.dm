...
/obj/item/ammo_magazine/ammo_box/foam
	...
	DEFAULT_MATTER(list(MAT_PLASTIC = 1800))
	max_ammo = 30
...
/obj/item/ammo_magazine/ammo_box/foam/riot
	...
	DEFAULT_MATTER(list(MAT_STEEL = 5040, MAT_PLASTIC = 1800))
...
/obj/item/ammo_magazine/ammo_box/cap
	...
	DEFAULT_MATTER(list(MAT_STEEL = 2040))
	max_ammo = 24
	multiple_sprites = null
...
/obj/item/ammo_magazine/ammo_box/b357
	...
	DEFAULT_MATTER(list(MAT_STEEL = 5040))
	max_ammo = 24
	multiple_sprites = 1
...
/obj/item/ammo_magazine/ammo_box/b38
	...
	DEFAULT_MATTER(list(MAT_STEEL = 1440))
	max_ammo = 24
	multiple_sprites = 1
...
/obj/item/ammo_magazine/ammo_box/b10mm/practice
	...
	DEFAULT_MATTER(list(MAT_STEEL = 2400))
	max_ammo = 40
	multiple_sprites = 1
...
/obj/item/ammo_magazine/ammo_box/b10mm/emp
	...
	DEFAULT_MATTER(list(MAT_STEEL = 5200, MAT_URANIUM = 4000))
	max_ammo = 40
	multiple_sprites = 1
...
/obj/item/ammo_magazine/ammo_box/b45/ap
	...
	DEFAULT_MATTER(list(MAT_STEEL = 1200, MAT_PLASTEEL = 600))
	max_ammo = 24
	multiple_sprites = 1
...
/obj/item/ammo_magazine/ammo_box/b45/hp
	...
	DEFAULT_MATTER(list(MAT_STEEL = 1440, MAT_PLASTIC = 360))
	max_ammo = 24
	multiple_sprites = 1
...
/obj/item/ammo_magazine/ammo_box/b45/emp
	...
	DEFAULT_MATTER(list(MAT_STEEL = 3120, MAT_URANIUM = 2400))
	max_ammo = 24
	multiple_sprites = 1
...
/obj/item/ammo_magazine/ammo_box/b12g
	...
	DEFAULT_MATTER(list(MAT_STEEL = 2880))
	max_ammo = 8
	multiple_sprites = 1
...
/obj/item/ammo_magazine/ammo_box/b12g/stunshell
	...
	DEFAULT_MATTER(list(MAT_STEEL = 2880, MAT_GLASS = 5760))
	max_ammo = 8
	multiple_sprites = 1
...
/obj/item/ammo_magazine/ammo_box/b12g/emp
	...
	DEFAULT_MATTER(list(MAT_STEEL = 2880, MAT_URANIUM = 1920))
	max_ammo = 8
	multiple_sprites = 1
...
/obj/item/ammo_magazine/ammo_box/b12g/flechette
	...
	DEFAULT_MATTER(list(MAT_STEEL = 2880, MAT_PLASTEEL = 800))
	max_ammo = 8
	multiple_sprites = 1
...
/obj/item/ammo_magazine/ammo_box/b12g/blank
	...
	DEFAULT_MATTER(list(MAT_STEEL = 720))
	max_ammo = 8
	multiple_sprites = 1
...
/obj/item/ammo_magazine/ammo_box/b12g/flash
	...
	DEFAULT_MATTER(list(MAT_STEEL = 720, MAT_GLASS = 720))
	max_ammo = 8
	multiple_sprites = 1
...
/obj/item/ammo_magazine/ammo_box/b145
	...
	DEFAULT_MATTER(list(MAT_STEEL = 28000, MAT_PLASTEEL = 3500)) // Makes them a bit more expensive
	max_ammo = 7
	multiple_sprites = 1
...
/obj/item/ammo_magazine/ammo_box/b145/highvel
	...
	DEFAULT_MATTER(list(MAT_STEEL = 2800, MAT_PLASTEEL = 7000)) // Makes them a bit more expensive
	max_ammo = 7
	multiple_sprites = 1
...
/obj/item/ammo_magazine/ammo_box/b762
	...
	DEFAULT_MATTER(list(MAT_STEEL = 6000))
	max_ammo = 30
	multiple_sprites = 1
...
/obj/item/ammo_magazine/ammo_box/b762/hp
	...
	DEFAULT_MATTER(list(MAT_STEEL = 9000))
	max_ammo = 30
	multiple_sprites = 1
...
/obj/item/ammo_magazine/ammo_box/b545
	...
	DEFAULT_MATTER(list(MAT_STEEL = 5400))
	max_ammo = 30
	multiple_sprites = 1
...
/obj/item/ammo_magazine/ammo_box/b545/ap
	...
	DEFAULT_MATTER(list(MAT_STEEL = 8100))
	max_ammo = 30
	multiple_sprites = 1
...
/obj/item/ammo_magazine/ammo_box/b545/large
	...
	caliber = "5.45mm"
	ammo_type = /obj/item/ammo_casing/a545
	DEFAULT_MATTER(list(MAT_STEEL = 18000))
	max_ammo = 100
	multiple_sprites = 1
...
/obj/item/ammo_magazine/ammo_box/b545/large/ap
	...
	caliber = "5.45mm"
	ammo_type = /obj/item/ammo_casing/a545/ap
	DEFAULT_MATTER(list(MAT_STEEL = 27000))
	max_ammo = 100
	multiple_sprites = 1
