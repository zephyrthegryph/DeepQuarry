...
/obj/item/ammo_magazine/ak74
	...
	mag_type = MAGAZINE
	caliber = "5.45mm"
	DEFAULT_MATTER(list(MAT_STEEL = 1400))
	multiple_sprites = 1
...
/obj/item/ammo_magazine/m16/ap
	...
	DEFAULT_MATTER(list(MAT_STEEL = 1700))
...
/obj/item/ammo_magazine/m16/patriot
	...
	DEFAULT_MATTER(list(MAT_STEEL = 5000))
	max_ammo = 100
...
/obj/item/ammo_magazine/m41/rubber
	...
	max_ammo = 40
	DEFAULT_MATTER(list(MAT_STEEL = 7000))
...
/obj/item/ammo_magazine/plamya
	...
	mag_type = MAGAZINE
	multiple_sprites = 1
	DEFAULT_MATTER(list(MAT_STEEL = 2500))
	ammo_type = /obj/item/ammo_casing/a9mm
...
/obj/item/ammo_magazine/molniya
	...
	mag_type = MAGAZINE
	multiple_sprites = 1
	DEFAULT_MATTER(list(MAT_STEEL = 8000))
	ammo_type = /obj/item/ammo_casing/a762
...
/obj/item/ammo_magazine/kord
	...
	mag_type = MAGAZINE
	multiple_sprites = 1
	DEFAULT_MATTER(list(MAT_STEEL = 20000))
...
/obj/item/ammo_magazine/akm/drum/ap
	...
	DEFAULT_MATTER(list(MAT_STEEL = 7500))
	ammo_type = /obj/item/ammo_casing/a762/ap
