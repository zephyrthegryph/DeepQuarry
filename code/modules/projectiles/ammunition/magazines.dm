...
/obj/item/ammo_magazine/mfoam_dart/pistol
	...
	DEFAULT_MATTER(list(MAT_PLASTIC = 250))
	caliber = "foam"
	max_ammo = 9
	multiple_sprites = 1
...
/obj/item/ammo_magazine/s357
	...
	DEFAULT_MATTER(list(MAT_STEEL = 1260))
	max_ammo = 6
	multiple_sprites = 1
...
/obj/item/ammo_magazine/s38
	...
	icon_state = "38"
	caliber = ".38"
	DEFAULT_MATTER(list(MAT_STEEL = 360))
...
/obj/item/ammo_magazine/m38/giskard
	...
	icon_state = "m91"
	mag_type = MAGAZINE
	DEFAULT_MATTER(list(MAT_STEEL = 540))
	caliber = ".38"
	ammo_type = /obj/item/ammo_casing/a38
	max_ammo = 10
	multiple_sprites = 1
...
/obj/item/ammo_magazine/m45
	...
	DEFAULT_MATTER(list(MAT_STEEL = 525)) //metal costs are very roughly based around 1 .45 casing = 75 metal
	caliber = ".45"
	max_ammo = 7
	multiple_sprites = 1
...
/obj/item/ammo_magazine/m45uzi
	...
	mag_type = MAGAZINE
	ammo_type = /obj/item/ammo_casing/a45
	DEFAULT_MATTER(list(MAT_STEEL = 1200))
	caliber = ".45"
	max_ammo = 16
	multiple_sprites = 1
...
/obj/item/ammo_magazine/m45tommy
	...
	mag_type = MAGAZINE
	ammo_type = /obj/item/ammo_casing/a45
	DEFAULT_MATTER(list(MAT_STEEL = 1500))
	caliber = ".45"
	max_ammo = 20
	multiple_sprites = 1
...
/obj/item/ammo_magazine/m45tommydrum
	...
	mag_type = MAGAZINE
	ammo_type = /obj/item/ammo_casing/a45
	DEFAULT_MATTER(list(MAT_STEEL = 3750))
	caliber = ".45"
	max_ammo = 50
	multiple_sprites = 1
...
/obj/item/ammo_magazine/clip/c45
	...
	caliber = ".45"
	ammo_type = /obj/item/ammo_casing/a45
	DEFAULT_MATTER(list(MAT_STEEL = 675)) // metal costs very roughly based around one .45 casing = 75 metal
	max_ammo = 9
	multiple_sprites = 1
...
/obj/item/ammo_magazine/m9mm
	...
	icon_state = "m91"
	mag_type = MAGAZINE
	DEFAULT_MATTER(list(MAT_STEEL = 600))
	caliber = "9mm"
...
/obj/item/ammo_magazine/m9mmt/ap
	...
	DEFAULT_MATTER(list(MAT_STEEL = 1000, MAT_PLASTEEL = 2000))
...
/obj/item/ammo_magazine/m9mmp90
	...
	mag_type = MAGAZINE
	ammo_type = /obj/item/ammo_casing/a9mm/ap
	DEFAULT_MATTER(list(MAT_STEEL = 3000))
	caliber = "9mm"
	max_ammo = 50
	multiple_sprites = 1
...
/obj/item/ammo_magazine/m9mmp90/rubber
	...
	ammo_type = /obj/item/ammo_casing/a9mm/rubber
	DEFAULT_MATTER(list(MAT_STEEL = 2000, MAT_PLASTIC = 1000))
// end
...
/obj/item/ammo_magazine/clip/c9mm
	...
	caliber = "9mm"
	ammo_type = /obj/item/ammo_casing/a9mm
	DEFAULT_MATTER(list(MAT_STEEL = 540)) // metal costs are very roughly based around one 9mm casing = 60 metal
	max_ammo = 9
	multiple_sprites = 1
...
/obj/item/ammo_magazine/m10mm/emp
	...
	DEFAULT_MATTER(list(MAT_STEEL = 1500, MAT_URANIUM = 2000))
...
/obj/item/ammo_magazine/m10mm/pistol/practice
	name = "magazine (10mm practice)"
	DEFAULT_MATTER(list(MAT_STEEL = 800))
	ammo_type = /obj/item/ammo_casing/a10mm/practice
...
/obj/item/ammo_magazine/m10mm/pistol/emp
	name = "magazine (10mm haywire)"
	DEFAULT_MATTER(list(MAT_STEEL = 1000, MAT_URANIUM = 1500))
	ammo_type = /obj/item/ammo_casing/a10mm/emp
...
/obj/item/ammo_magazine/m545
	...
	mag_type = MAGAZINE
	caliber = "5.45mm"
	DEFAULT_MATTER(list(MAT_STEEL = 1800))
...
/obj/item/ammo_magazine/m545/ext
	...
	DEFAULT_MATTER(list(MAT_STEEL = 2700))
	max_ammo = 30
...
/obj/item/ammo_magazine/m545/small
	...
	DEFAULT_MATTER(list(MAT_STEEL = 900))
	max_ammo = 10
...
/obj/item/ammo_magazine/clip/c545
	...
	caliber = "5.45mm"
	ammo_type = /obj/item/ammo_casing/a545
	DEFAULT_MATTER(list(MAT_STEEL = 450)) // metal costs are very roughly based around one 10mm casing = 180 metal
	max_ammo = 5
	multiple_sprites = 1
...
/obj/item/ammo_magazine/m545saw
	...
	mag_type = MAGAZINE
	caliber = "5.45mm"
	DEFAULT_MATTER(list(MAT_STEEL = 10000))
	ammo_type = /obj/item/ammo_casing/a545
...
/obj/item/ammo_magazine/clip/c44
	...
	caliber = ".44"
	ammo_type = /obj/item/ammo_casing/a44
	DEFAULT_MATTER(list(MAT_STEEL = 1620)) // metal costs are very roughly based around one .50 casing = 180 metal
	max_ammo = 9
	multiple_sprites = 1
...
/obj/item/ammo_magazine/s44
	...
	icon_state = "44"
	ammo_type = /obj/item/ammo_casing/a44
	DEFAULT_MATTER(list(MAT_STEEL = 1260)) //metal costs are very roughly based around 1 .45 casing = 75 metal
	caliber = ".44"
	max_ammo = 6
	multiple_sprites = 1
...
/obj/item/ammo_magazine/m762/ext
	...
	icon_state = "m762"
	DEFAULT_MATTER(list(MAT_STEEL = 4000))
	max_ammo = 20
...
/obj/item/ammo_magazine/m762enbloc
	...
	mag_type = MAGAZINE
	caliber = "7.62mm"
	DEFAULT_MATTER(list(MAT_STEEL = 1600))
	ammo_type = /obj/item/ammo_casing/a762
	max_ammo = 8
	multiple_sprites = 1
...
/obj/item/ammo_magazine/clip/c762
	...
	caliber = "7.62mm"
	ammo_type = /obj/item/ammo_casing/a762
	DEFAULT_MATTER(list(MAT_STEEL = 1000)) // metal costs are very roughly based around one 7.62 casing = 200 metal
	max_ammo = 5
	multiple_sprites = 1
...
/obj/item/ammo_magazine/m12gdrum
	...
	mag_type = MAGAZINE
	caliber = "12g"
	DEFAULT_MATTER(list(MAT_STEEL = 13000))
...
/obj/item/ammo_magazine/clip/c12g
	...
	caliber = "12g"
	ammo_type = /obj/item/ammo_casing/a12g
	DEFAULT_MATTER(list(MAT_STEEL = 1070))
	max_ammo = 2
	multiple_sprites = 1
...
/obj/item/ammo_magazine/clip/c12g/beanbag
	...
	ammo_type = /obj/item/ammo_casing/a12g/beanbag
	DEFAULT_MATTER(list(MAT_STEEL = 710))
...
/obj/item/ammo_magazine/clip/c12g/scatter
	...
	DEFAULT_MATTER(list(DEFAULT_WALL_MATERIAL = 1337))
...
/obj/item/ammo_magazine/m2024
	...
	mag_type = MAGAZINE
	ammo_type = /obj/item/ammo_casing/a45
	DEFAULT_MATTER(list(DEFAULT_WALL_MATERIAL = 525)) //metal costs are very roughly based around 1 .45 casing = 75 metal
	caliber = ".45"
	max_ammo = 7
	multiple_sprites = 1
...
/obj/item/ammo_magazine/mglock9mm
	...
	icon = 'icons/obj/gun_yw.dmi'
	mag_type = MAGAZINE
	DEFAULT_MATTER(list(DEFAULT_WALL_MATERIAL = 480))
	caliber = "9mm"
	ammo_type = /obj/item/ammo_casing/a9mm
	max_ammo = 17
	multiple_sprites = 0
...
/obj/item/ammo_magazine/mg42
	...
	mag_type = MAGAZINE
	DEFAULT_MATTER(list(DEFAULT_WALL_MATERIAL = 10000))
