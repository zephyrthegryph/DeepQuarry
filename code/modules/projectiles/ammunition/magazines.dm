...
/obj/item/ammo_magazine/m45
	...
	MATERIAL_BULK(MAT_STEEL, 525) //metal costs are very roughly based around 1 .45 casing = 75 metal
	caliber = ".45"
	max_ammo = 7
	multiple_sprites = 1
...
/obj/item/ammo_magazine/clip/c45
	...
	caliber = ".45"
	ammo_type = /obj/item/ammo_casing/a45
	MATERIAL_BULK(MAT_STEEL, 675) // metal costs very roughly based around one .45 casing = 75 metal
	max_ammo = 9
	multiple_sprites = 1
...
/obj/item/ammo_magazine/clip/c9mm
	...
	caliber = "9mm"
	ammo_type = /obj/item/ammo_casing/a9mm
	MATERIAL_BULK(MAT_STEEL, 540) // metal costs are very roughly based around one 9mm casing = 60 metal
	max_ammo = 9
	multiple_sprites = 1
...
/obj/item/ammo_magazine/clip/c545
	...
	caliber = "5.45mm"
	ammo_type = /obj/item/ammo_casing/a545
	MATERIAL_BULK(MAT_STEEL, 450) // metal costs are very roughly based around one 10mm casing = 180 metal
	max_ammo = 5
	multiple_sprites = 1
...
/obj/item/ammo_magazine/clip/c44
	...
	caliber = ".44"
	ammo_type = /obj/item/ammo_casing/a44
	MATERIAL_BULK(MAT_STEEL, 1620) // metal costs are very roughly based around one .50 casing = 180 metal
	max_ammo = 9
	multiple_sprites = 1
...
/obj/item/ammo_magazine/s44
	...
	icon_state = "44"
	ammo_type = /obj/item/ammo_casing/a44
	MATERIAL_BULK(MAT_STEEL, 1260) //metal costs are very roughly based around 1 .45 casing = 75 metal
	caliber = ".44"
	max_ammo = 6
	multiple_sprites = 1
...
/obj/item/ammo_magazine/clip/c762
	...
	caliber = "7.62mm"
	ammo_type = /obj/item/ammo_casing/a762
	MATERIAL_BULK(MAT_STEEL, 1000) // metal costs are very roughly based around one 7.62 casing = 200 metal
	max_ammo = 5
	multiple_sprites = 1
...
/obj/item/ammo_magazine/clip/c12g/scatter
	...
	MATERIAL_BULK(DEFAULT_WALL_MATERIAL, 1337)
...
/obj/item/ammo_magazine/m2024
	...
	mag_type = MAGAZINE
	ammo_type = /obj/item/ammo_casing/a45
	MATERIAL_BULK(DEFAULT_WALL_MATERIAL, 525) //metal costs are very roughly based around 1 .45 casing = 75 metal
	caliber = ".45"
	max_ammo = 7
	multiple_sprites = 1
...
/obj/item/ammo_magazine/mglock9mm
	...
	icon = 'icons/obj/gun_yw.dmi'
	mag_type = MAGAZINE
	MATERIAL_BULK(DEFAULT_WALL_MATERIAL, 480)
	caliber = "9mm"
	ammo_type = /obj/item/ammo_casing/a9mm
	max_ammo = 17
	multiple_sprites = 0
...
/obj/item/ammo_magazine/mg42
	...
	mag_type = MAGAZINE
	MATERIAL_BULK(DEFAULT_WALL_MATERIAL, 10000)
