...
/obj/item/gun/projectile/automatic/serdy/hunter
	name = "SOK-94"
	desc = "Otherwise known as a Vepr Super. An AK pattern rifle, based on the beefier RPK chassis, to handle larger caliber rounds. Like an SVD but cooler. Chambered in 7.62mm."
	caliber = "7.62mm"
	item_icons = list(
		slot_l_hand_str = 'icons/mob/items/lefthand_guns_ch.dmi',
		slot_r_hand_str = 'icons/mob/items/righthand_guns_ch.dmi',
...
/obj/item/gun/projectile/automatic/serdy/m16a2
	name = "M16A2"
	desc = "A favorite service rifle everywhere, even today. It might be a reproduction, but Eugene Stoner smiles upon every man or woman who wields this beautiful democracy dispensing machine, even if it's never seen the soil of Terra, and never will. Chambered in 5.56mm."
	caliber = "5.56mm"
	item_icons = list(
		slot_l_hand_str = 'icons/mob/items/lefthand_guns_ch.dmi',
		slot_r_hand_str = 'icons/mob/items/righthand_guns_ch.dmi',
...
/obj/item/gun/projectile/automatic/serdy/m4a1
	name = "M4A1"
	desc = "The M16's shorter, more lightweight little brother. An old terran flag is stamped into the receiver. These guns can be found just about everywhere. A favorite on the rimworlds due to its simplicity to produce, and reliability. Chambered in 5.56mm."
	caliber = "5.56mm"
	item_icons = list(
		slot_l_hand_str = 'icons/mob/items/lefthand_guns_ch.dmi',
		slot_r_hand_str = 'icons/mob/items/righthand_guns_ch.dmi',
...
/obj/item/gun/projectile/automatic/serdy/patriot
	name = "Patriot"
	desc = "I raised you, and loved you, I've given you weapons, taught you techniques, endowed you with knowledge. There's nothing more for me to give you. All that's left for you to take is my life. 'Still in a dream' is stamped into the receiver, and it has no serial number. Chambered in 5.56mm."
	caliber = "5.56mm"
	item_icons = list(
		slot_l_hand_str = 'icons/mob/items/lefthand_guns_ch.dmi',
		slot_r_hand_str = 'icons/mob/items/righthand_guns_ch.dmi',
...
/obj/item/gun/projectile/automatic/serdy/keltec
	name = "RDB-S"
	desc = "A snazzy survival rifle, small enough to fit into a backpack. Despite it's odd shape, it's pretty comfortable in the hands. This one is OD green. Chambered in 5.56mm."
	caliber = "5.56mm"
	auto_loading_type = CLOSED_BOLT | LOCK_OPEN_EMPTY
	load_method = MAGAZINE
	magazine_type = /obj/item/ammo_magazine/m16
...
/obj/item/gun/projectile/automatic/serdy/keltec/black
	icon_state = "keltecB"
	desc = "A snazzy survival rifle, small enough to fit into a backpack. Despite it's odd shape, it's pretty comfortable in the hands. This one is black. Chambered in 5.56mm."

/obj/item/gun/projectile/automatic/serdy/keltec/blue
	icon_state = "keltecN"
	desc = "A snazzy survival rifle, small enough to fit into a backpack. Despite it's odd shape, it's pretty comfortable in the hands. This one is Sif-blue. Chambered in 5.56mm."

/obj/item/gun/projectile/automatic/serdy/keltec/white
	icon_state = "keltecW"
	desc = "A snazzy survival rifle, small enough to fit into a backpack. Despite it's odd shape, it's pretty comfortable in the hands. This one is snow white. Chambered in 5.56mm."

/obj/item/gun/projectile/automatic/serdy/keltec/tan
	icon_state = "keltecD"
	desc = "A snazzy survival rifle, small enough to fit into a backpack. Despite it's odd shape, it's pretty comfortable in the hands. This one is coyote tan. Chambered in 5.56mm."
...
/obj/item/gun/projectile/automatic/serdy/sks 	//Reminder to myself to make sure this works and also to make sure that people are able to empty the internal mag
	name = "SKS"
	desc = "Just looking at it makes you want to buy a tacticool turtleneck, go into the woods, and -operate-. Chambered in 7.62mm."
	caliber = "7.62mm"
	auto_loading_type = CLOSED_BOLT | LOCK_OPEN_EMPTY
...
/obj/item/gun/projectile/automatic/serdy/mosin
	name = "Mosin Nagant"
	desc = "A reproduction of some old russian bolt-action rifle from some backwater rimworld. Smells strongly of cosmoline. The inscriptions on it are in pan-slavic. Chambered in 7.62mm."
	caliber = "7.62mm"
...
/obj/item/gun/projectile/automatic/serdy/mosin/scoped
	...
	desc = "A reproduction of some old russian bolt-action rifle from some backwater rimworld. Smells strongly of cosmoline. The inscriptions on it are in pan-slavic. This one has a scope attached to it. Chambered in 7.62mm."
	actions_types = list(/datum/action/item_action/use_scope)
	accuracy = -15
	scoped_accuracy = 50
	one_handed_penalty = 70
...
/obj/item/gun/projectile/automatic/serdy/memegun
	...
	desc = "Три полоски, три по три полоски Три полоски, три по три полоски Три полоски, три по три полоски Три полоски, три по три полоски Три полоски, три по три полоски Три полоски, три по три полоски. Chambered in 7.62mm"
	caliber = "7.62mm"
	item_icons = list(
		slot_l_hand_str = 'icons/mob/items/lefthand_guns_ch.dmi',
		slot_r_hand_str = 'icons/mob/items/righthand_guns_ch.dmi',
...
/obj/item/gun/projectile/automatic/serdy/tkb408
	name = "TKB-408"
	desc ="An odd, bullpup, slavic assault rifle from some distant rimworld. Very sturdy, unbeleivably reliable. Chambered in 7.62mm."
	caliber = "7.62mm"
	magazine_type = /obj/item/ammo_magazine/akm
	allowed_magazines = list(/obj/item/ammo_magazine/akm)
	icon_state = "tkb"
...
/obj/item/gun/projectile/automatic/serdy/groza
	name = "OTs-14"
	desc = "A strangely ergonomic bullpup version of an AK. Commonly found in Pan-slavic speaking regions of space. All of the inscriptions on this thing are in pan-slavic. Chambered in 7.62mm."
	caliber = "7.62mm"
	magazine_type = /obj/item/ammo_magazine/akm
	allowed_magazines = list(/obj/item/ammo_magazine/akm)
	icon_state = "groza"
...
/obj/item/gun/projectile/automatic/serdy/ppsh
	...
	caliber = ".45" //Lets just make it a c20 alt
	item_icons = list(
		slot_l_hand_str = 'icons/mob/items/lefthand_guns_ch.dmi',
		slot_r_hand_str = 'icons/mob/items/righthand_guns_ch.dmi',
		)
...
/obj/item/gun/projectile/automatic/serdy/pkm
	name = "PKM"
	desc = "A traditional russian machinegun. A classic Pan-slav weapon. Chambered in 7.62mm."
	caliber = "7.62mm"
...
/obj/item/gun/projectile/automatic/serdy/rpd
	name = "RPDM"
	desc = "An unusual LMG that shares similarities with both the AK and the PKM. Perfect for storming the Reichstag. Chambered in 7.62mm."
	caliber = "7.62mm"
...
/obj/item/gun/projectile/automatic/serdy/rpk //RPK is the imposter of the LMGs, not a true LMG! Close enough to be in this section, though.
	name = "RPK"
	desc = "The AK's bigger brother, and the PKM's little brother. More of an LSW than an LMG. Chambered in 7.62mm."
	caliber = "7.62mm"
