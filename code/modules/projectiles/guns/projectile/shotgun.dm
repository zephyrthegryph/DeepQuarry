...
/obj/item/ammo_magazine/m12gdrumjack
	...
	mag_type = MAGAZINE
	caliber = "12g"
	DEFAULT_MATTER(list(DEFAULT_WALL_MATERIAL = 1300)) //did the math. now fixed the exploityness of this thing. Have fun!
	ammo_type = /obj/item/ammo_casing/a12g
	max_ammo = 4
	multiple_sprites = 1
...
/obj/item/ammo_magazine/m12gdrumjack/empty
	...
	initial_ammo = 0
	DEFAULT_MATTER(list(DEFAULT_WALL_MATERIAL = 1625)) //Why these cost so much ? the normal ones have 13000 matter so i just multiplied by 1.25(default) don't know why it costs so much
...
/obj/item/ammo_casing/a12g/scatter
	...
	DEFAULT_MATTER(list(DEFAULT_WALL_MATERIAL = 450))
