...
/obj/item/gun/energy/locked/phasegun
	...
	charge_cost = 160 // Bringing charge cost down for all phase weapons. 15 shots on normal cell
...
/obj/item/gun/energy/locked/phasegun/unlocked/mounted/cyborg
	charge_cost = 160 // Reduced from 480 to 200, further reduced to 80 to match normal phase guns
	recharge_time = 16 // set up to 16 due to lower charge cost
