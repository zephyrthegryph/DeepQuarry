...
/obj/item/electronic_assembly/drone
	...
	w_class = ITEMSIZE_NORMAL
	max_components = IC_COMPONENTS_BASE * 3 //Changing this to be 3 instead because as it stands its worthless
	max_complexity = IC_COMPLEXITY_BASE * 3 //Changing this to be 3 instead because as it stands its worthless
	can_anchor = FALSE
