...
/mob/proc/changeling_lsdsting()
	...
	addtimer(VARSET_CALLBACK(T, status_units(EFFECT_HALLUCINATING), min(T.status_units(EFFECT_HALLUCINATING)+400, 400)), rand(30 SECONDS, 60 SECONDS), TIMER_DELETE_ME) //No going ABOVE 400 hallucinations.
