...
- `auxmos_init_bridge.dm` — hand-written auxmos FFI routes into the combined
  Verdigris library.
- `xgm_compat.dm` — forwarding-proc shim providing XGM-style
...
5. Rebuild and run the unit-test boot (`bin/test.cmd`); reconcile any drift against
