...
DreamMaker: This should have opened with our filetree, as screenshotted. [https://i.imgur.com/m8FjRAs.png](https://i.imgur.com/m8FjRAs.png) If it did not, navigate to File, Open Environment, and select deepquarry.dme. Then, navigate to maps, submaps, surface submaps, wilderness, and open wilderness_areas.dm.
...
With that done, hit Open Environment, and navigate to the folder we downloaded in the earlier step. Open deepquarry.dme, for VORE + CHOMP, or Polaris.dme for Polaris.
