...
| B16 | `fire_stacks.dm:237`, `:224` | `harm_human` passes the number of fire stacks as the exposure temperature, and calls `hotspot_expose` every tick | Pass the real temperature | H3 |
